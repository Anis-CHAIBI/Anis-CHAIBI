...
$list = $reservationC->listReservations();
...
<div class="container p-5">
        ...
        ?>
            <tr>
                <td><?= $reservation['IdReser']; ?></td>
                <td><?= $reservation['dateReser']; ?></td>
                <td><?= $reservation['types_transport']; ?></td>
                <td align="center">
                    <form method="POST" action="updateReservation.php">
                        <input type="submit" name="update" value="Update">
                        <input type="hidden" value=<?PHP echo $reservation['IdReser']; ?> name="IdReser">
                    </form>
                </td>
                <td>
                    <a href="deleteReservation.php?IdReser=<?php echo $reservation['IdReser']; ?>">Delete</a>
                </td>
            </tr>
        <?php
        }
    ...
    <a class="btn btn-primary" href="addReservation.php">Add Reservation </a>
    <a class="btn btn-primary" href="SearchReservation.php">Search Reservation </a>
    <a class="btn btn-primary" href="SortReservation.php">Sort Reservation </a>
</div>
</section>
  </main><!-- End #main -->
